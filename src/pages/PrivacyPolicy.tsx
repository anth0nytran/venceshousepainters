    ...
    return (
        <LegalPage title="Privacy Policy">
            <Section title="Overview">
                <p>{BRAND_NAME}, operated by {LEGAL_ENTITY} ("we," "us," or "our"), respects your privacy. This policy explains what information we collect through {DOMAIN}, how we use it, and the choices you have. By using this website or contacting us, you agree to this policy.</p>
            </Section>
